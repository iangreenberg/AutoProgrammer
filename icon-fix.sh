...
cp "./icons/icons/mac/icon.icns" "$HOME/Desktop/AutoProgrammer.app/Contents/Resources/icon.icns"

# 2. Set proper icon file permissions
echo "Setting proper file permissions..."
chmod 644 "$HOME/Desktop/AutoProgrammer.app/Contents/Resources/icon.icns"

# 3. Touch the app to update modification time
echo "Updating app modification time..."
touch "$HOME/Desktop/AutoProgrammer.app"
...
tell application \"Finder\"
    set file_path to POSIX file \"$HOME/Desktop/AutoProgrammer.app\" as alias
